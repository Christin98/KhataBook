...
export default function QuickAddModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="relative w-full max-w-lg glass-panel bg-white/95 dark:bg-slate-900/95 rounded-3xl shadow-2xl border border-white/40 dark:border-white/10 p-6 sm:p-7 overflow-hidden z-10 space-y-5">
        {/* Modal Header */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-200/50 dark:border-white/10">
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-black text-slate-900 dark:text-white">Fast Entry</h3>
        ...
        <div className="grid grid-cols-2 gap-2 p-1.5 glass-subtle rounded-2xl">
          <button
        ...
        {isSuccess ? (
          ...
          <form onSubmit={handleSavePersonal} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-500 hover:to-indigo-500 text-white font-black text-sm shadow-lg shadow-brand-500/25 transition-all active:scale-95 border border-white/20 cursor-pointer"
            >
              Save Transaction
            </button>
          </form>
                      ...
                      return (
                        ...
                        >
                          ...
                          {isSelected && parseFloat(circleAmount) > 0 && selectedCircleMemberIds.length > 0 && (
                            <span className="text-[11px] text-brand-600 dark:text-brand-400 font-black">
