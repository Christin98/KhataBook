  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <div className="flex-1 flex flex-col min-w-0 pb-16 lg:pb-0">
        ...
        {/* Global Page Footer */}
        <footer className="mt-auto py-6 px-4 sm:px-6 lg:px-8 border-t border-slate-200/60 dark:border-slate-800/60 text-xs text-slate-400 flex flex-col sm:flex-row items-center justify-between gap-2 max-w-7xl w-full mx-auto">
          <div className="flex items-center gap-2">
            ...
            <span>•</span>
            <span className="truncate max-w-md">{APP_INFO.description}</span>
          </div>
