...
export const SAMPLE_CREDIT_CARDS: CreditCard[] = [
  {
    ...
    status: 'Active',
    cardColor: 'from-purple-900 via-indigo-900 to-slate-950',
  ...
  },
  {
    ...
    annualFee: 0,
    rewardType: 'Cashback',
    rewardRate: '5% on Amazon, 1% others',
    status: 'Active',
    cardColor: 'from-amber-800 via-stone-900 to-black',
  ...
  },
  {
    ...
    annualFee: 999,
    rewardType: 'Cashback',
    rewardRate: '5% on online spends',
    status: 'Active',
    cardColor: 'from-blue-900 via-sky-950 to-slate-950',
    createdAt: '2025-05-20T00:00:00.000Z'
  }
];

export const SAMPLE_STATEMENTS: CreditCardStatement[] = [
  {
    id: 'stmt_hdfc_aug',
  ...
  },
  {
    ...
    billingPeriodStart: '2026-06-21',
    billingPeriodEnd: '2026-07-20',
    statementAmount: 16400,
    minimumDue: 1600,
...
export const SAMPLE_PAYMENTS: CreditCardPayment[] = [
  {
    id: 'pay_hdfc_jul',
    cardId: 'cc_hdfc_regalia',
    statementId: 'stmt_hdfc_jul',
    accountId: 'acc_hdfc',
    amount: 22100,
    paymentDate: '2026-08-03',
    paymentType: 'statement',
    notes: 'Auto-debit bill payment from HDFC Salary Account',
    createdAt: '2026-08-03T10:00:00.000Z'
  },
  {
    id: 'pay_icici_jul',
    cardId: 'cc_icici_amazon',
    statementId: 'stmt_icici_jul',
    accountId: 'acc_icici',
    amount: 16400,
    paymentDate: '2026-08-08',
    paymentType: 'full',
    notes: 'Full bill clearance via NetBanking',
...
export const SAMPLE_EMIS: EMI[] = [
  {
    ...
    purchaseTitle: 'iPhone 16 Pro Max 256GB',
  ...
  },
  {
    ...
    purchaseTitle: 'MacBook Air M3 Work Laptop',
    purchaseAmount: 114000,
    downPayment: 24000,
    principalAmount: 90000,
    interestAmount: 10420,
    processingFee: 1499,
    taxAmount: 269.82,
    totalPayable: 102188.82,
    monthlyEmi: 5578,
    emiAmount: 5578,
    tenureMonths: 18,
    paidMonths: 6,
